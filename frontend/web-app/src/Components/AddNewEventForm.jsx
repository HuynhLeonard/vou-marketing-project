...
import { callApiCreateEvent, callApiUploadEventImgs } from "../service/event";
...
const AddNewEventForm = () => {
    ...
    const createEventMutation = useMutation(
        async (data) => {
            ...
            const images =
                banner == undefined && qrImg == undefined && voucherImg == undefined
                    ? null
                    : {
                          bannerFile: banner,
                          QRImage: qrImg,
    ...
    const checkValidateData = (formProps) => {
        ...
        if (
            dataEvent.voucher_code === "" ||
            dataEvent.voucher_description === "" ||
            dataEvent.voucher_name === "" ||
            dataEvent.voucher_price === ""
        ) {
            setIsError(true);
            setShowNoti(true);
        ...
        <div className="ml-[500px] container w-full P-5 bg-white" data-theme="retro">
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="container flex bg-base-100 shadow-md rounded-3xl py-5 px-5 my-4 gap-5 border border-gray-200">
                        <form
                            className="container"
                            ref={formDataEvent}
                                ...
                                <div>
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex flex-col px-2 py-2 grow">
                                            ...
                                            <input
                                                ...
                                                placeholder="Tên"
                                                name="eventName"
                                                defaultValue={dataEvent.eventName || ""}
                                                required
                                            />
                                        </div>
                                    ...
                                    <div className="flex gap-4">
                                        <div className="flex flex-col px-2 py-2 grow ">
                                            ...
                                            <DatePicker
                                                ...
                                                className="input_text w-full input input-bordered input-info"
                                    ...
                                    <div className="flex gap-4">
                                        <div className="flex flex-col px-2 py-2 grow">
                                            ...
                                            <input
                                                ...
                                                name="voucher_name"
                                                defaultValue={dataEvent.voucher_name}
                                                required
                                            />
                                        </div>
                                        ...
                                        <div className="flex flex-col px-2 py-2 grow">
                                            ...
                                            <input
                                                ...
                                                placeholder="XXXXXX"
                                                name="voucher_code"
                                                defaultValue={dataEvent.voucher_code}
                                                required
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        <div className="flex flex-col px-2 py-1 grow">
                                            ...
                                            {openCategoryVoucher ? (
                                                <div
                                                    className="absolute z-10 mt-[80px] w-[250px] origin-top-right rounded-lg bg-base-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                                    role="menu"
                                        ...
                                        <div className="flex flex-col px-2 py-2 grow">
                                            ...
                                            <input
                                                ...
                                                placeholder="VNĐ"
                                                name="voucher_price"
                                                defaultValue={dataEvent.voucher_price}
                                                min={10000}
                                                required
                                            />
                                        </div>
                                    ...
                                    <div className="flex flex-col px-2 py-2 h-[200px]">
                                        ...
                                        <textarea
                                            type="text"
                                            className="input_text h-full input input-bordered input-info"
                                            placeholder="Mô tả ngắn gọn về cách sử dụng voucher"
                                            name="voucher_description"
                                            defaultValue={dataEvent.voucher_description}
                                            required
                                        />
                                    </div>
                                    ...
                                    <div
                                        className="primary_btn w-[200px] mt-8 btn btn-info"
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4">
                                        <div className="flex flex-col px-2 py-1 min-w-[424px] ">
                                            ...
                                            <div
                                                className="input_dropdown input input-bordered input-info"
                                                onClick={() => changeCategory(openCategory)}
                                            >
                                                <div class="flex items-center mt-2">
                                                    <span className="text-gray-900">
                                                        {gameType}
                                            ...
                                            {openCategory ? (
                                                <div
                                                    className="absolute z-10 mt-[88px] w-[400px] origin-top-right rounded-lg bg-base-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                                    role="menu"
                                                    aria-orientation="vertical"
                                                    aria-labelledby="menu-button"
                                                >
                                                ...
                                                <input
                                                    ...
                                                    className={`${
                                                        hasItemCoin
                                                            ? "input_text"
                                                            : "input_text_disabled"
                                                    } input input-bordered input-info max-w-[404px]`}
                                                    placeholder=""
                                                    disabled={!hasItemCoin}
                                                    name="aim_coin"
                                                    min={0}
                                                    defaultValue={dataEvent.gameInfoDTO?.aim_coin}
                                                    required
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex gap-4 w-[422px]">
                                        <div
                                            className="outline_btn w-[200px] mt-8 btn btn-error"
                                            onClick={() => changeForm(isEventForm)}
                                        >
                                            Trở lại
                                        </div>
