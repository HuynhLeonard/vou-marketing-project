...
import com.voufinal.mc_service.constant.Constant;
import com.voufinal.mc_service.dto.QuizDto;
import com.voufinal.mc_service.library.RedisLibrary;
import com.voufinal.mc_service.model.Option;
import com.voufinal.mc_service.model.Quiz;
import com.voufinal.mc_service.model.QuizRedis;
import com.voufinal.mc_service.model.UserResult;
...
public class MessageService {
    ...
    private final RedisLibrary redisCache;
    private final ObjectMapper objectMapper;
    private final EventSchedulerService eventSchedulerService;

    @Autowired
    public MessageService(SocketService socketService, RedisLibrary redisCache, EventSchedulerService eventSchedulerService) {
    ...
    public void sendUserListUpdate(String room) {
        ...
        socketService.sendMessage(room, String.valueOf(users.size()), "SERVER", null, Constant.AMOUNT);
    }
    ...
    private void handleQuestionTimeout(String room) {
        ...
        for (int i = 0; i < results.size(); i++) {
            ...
            String message = String.format("Your score is %s. You are ranked %d out of %d.",
