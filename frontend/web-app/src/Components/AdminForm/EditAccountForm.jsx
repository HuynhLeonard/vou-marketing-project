        ...
        <form className="container ml-4 mr-4" ref={formAccount}>
          <div className="flex flex-col gap-4">
            ...
            <div className="w-[150px] h-[150px]">
              <img src="" alt="avt" className="h-[150px] w-[150px] rounded-full" />
            </div>
            <div className="flex flex-row items-center ">
              <label className="flex flex-col justify-between mr-8 w-full">
                Họ và tên
                <input type="text" name="fullName" value="Leonard" onChange={handleChange} className="input_text" />
              </label>
              <label className="flex flex-col justify-between mr-8 w-full">
                Username
                <input type="text" name="username" value="Leonard" onChange={handleChange} className="input_text" />
              </label>
            </div>
            <div className="flex flex-row items-center">
              <label className="flex flex-col justify-between mr-8 w-full">
                Email
                <input type="email" name="email" value="A" onChange={handleChange} className="input_text" />
              </label>
              <label className="flex flex-col justify-between mr-8 w-full">
                Số điện thoại
                <input type="number" name="phoneNumber" value="A" onChange={handleChange} className="input_text" />
              </label>
            </div>
            <div className="flex flex-row items-center">
